...
- 2026-06-26 16:11: добавил ?
- 2026-06-26 16:09: Добавь в ROADMAP.md новую задачу в Фазу 8: в самом начале. Назови 8.0
- [ ] Починить Telegram-relay (сетевой таймаут к api.telegram.org) и добавить двустороннюю связь: агент должен читать вопросы из Human Input в BOARD.md и отправлять ответы в Telegram
